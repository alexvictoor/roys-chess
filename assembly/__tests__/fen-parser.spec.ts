...
describe("FEN generator", () => {
  it("should generate a FEN string equal to FEN string used to instantiate board", () => {
    ...
    const board = parseFEN(fen);
    // then
    //expect(board.toFEN()).toBe("rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b Kk e3 7 1");
    expect(board.toFEN()).toBe("rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b Kk e3 7 0");
  });
});
